...
namespace Nebula.Core
{
    ...
    public enum SpecialRole
    {
        ...
        Tracker = 4,       // экипаж: ведёт метку выбранного участника
        GuardianAngel = 5, // экипаж: погибнув, прикрывает живых щитом
        Noisemaker = 6,    // экипаж: место его гибели видно всем
        Phantom = 7,       // предатель: временно исчезает из виду
    }
